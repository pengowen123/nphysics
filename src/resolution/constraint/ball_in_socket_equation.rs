...
pub fn fill_second_order_equation<N: Real>(dt: N,
    ...
    cancel_relative_linear_motion(dt,
                                  &joint.anchor1_pos(),
                                  &joint.anchor2_pos(),
                                  joint.anchor1(),
                                  joint.anchor2(),
...
pub fn cancel_relative_linear_motion<N: Real, P>(dt: N,
                                                 global1: &Point<N>,
                                                 global2: &Point<N>,
                                                 anchor1: &Anchor<N, P>,
                                                 anchor2: &Anchor<N, P>,
    ...
    for i in 0usize..na::dimension::<Vector<N>>() {
        ...
        let dvel = contact_equation::relative_velocity(&opt_rb1.as_ref().map(|r| &**r),
        ...
        contact_equation::fill_constraint_geometry(lin_axis,
                                                   rot_axis1,
                                                   rot_axis2,
...
#[inline]
pub fn write_anchor_id<'a, N: Real, P>(anchor: &'a Anchor<N, P>,
                                       id: &mut isize)
                                       -> Option<RwLockReadGuard<'a, RigidBody<N>>> {
    match anchor.body {
        Some(ref b) => {
