...
pub fn explicit_integrate<N: Real>(
    dt: N,
    p: &Isometry<N>,
    c: &Point<N>,
    lv: &Vector<N>,
...
pub fn explicit_integrate_wo_rotation<N: Real>(
    dt: N,
    p: &Point<N>,
    lv: &Vector<N>,
    lf: &Vector<N>,
...
pub fn semi_implicit_integrate<N: Real>(
    dt: N,
    p: &Isometry<N>,
    c: &Point<N>,
    lv: &Vector<N>,
    ...
    (displacement(dt.clone(), p, c, &nlv, &nav), nlv, nav)
}

/// Semi-implicit Euler integrator. This will not update the rotational components.
pub fn semi_implicit_integrate_wo_rotation<N: Real>(
    dt: N,
    p: &Point<N>,
    lv: &Vector<N>,
    lf: &Vector<N>,
